.. _nuingressauditacltemplate:

nuingressauditacltemplate
===========================================

.. class:: nuingressauditacltemplate.NUIngressAuditACLTemplate(bambou.nurest_object.NUMetaRESTObject,):
...
- ``priority_type``: Possible values: TOP_AUDIT. This policy will be the top most ingress policy
